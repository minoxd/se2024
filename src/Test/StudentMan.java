...
import a2_22BI13047.studentman.PostgradStudent;
import a2_22BI13047.studentman.Student;
import a2_22BI13047.studentman.UndergradStudent;
...
public class StudentMan {
	public static void main(String[] args) {
		...
		System.out.println(students.get(0).toHtmlDoc());
		System.out.println(students.get(1).toHtmlDoc());
		System.out.println(students.get(2).toHtmlDoc());
	}
}
