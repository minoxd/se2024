...
import a2_22BI13047.kengine.Doc;
import a2_22BI13047.kengine.DocCnt;
import a2_22BI13047.kengine.Engine;
import a2_22BI13047.kengine.Query;
...
public class ProgStudentMan {
  ...
  public String toString() {
	  ...
	  Iterator<? extends Comparable> iter = objectIterator();
	  while (iter.hasNext()) {
  ...
  public UndergradStudent createUndergradStudent(Object[] data) 
		  ...
		  String phoneNumber = (String) data[2];
		  String address = (String) data[3];
		  return new UndergradStudent(id, name, phoneNumber, address);
  }
  ...
  public PostgradStudent createPostgradStudent(Object[] data) 
		  ...
		  return new PostgradStudent(id, name, phoneNumber, address, gpa);
  }
  ...
  public Query search(String[] words) 
	  ...
	  if (words == null || words.length <= 0) {
		  throw new NotPossibleException("ProgStudentMan.search: Provided array of Strings is either null or empty");
	  }
